...
<template>
  <div class="mx-auto flex w-full max-w-3xl flex-col items-start px-6 py-24 md:py-32">
    ...
    <RouterLink
      v-if="showHome"
      to="/"
      class="mt-9 inline-flex items-center gap-2 rounded-md border border-gray-200 px-5 py-3 min-h-[44px] font-mono text-[13px] text-gray-600 hover:border-gray-300 hover:text-ink"
    >
