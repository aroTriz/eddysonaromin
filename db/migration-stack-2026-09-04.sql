-- Stack sync 2026-09-04 — updates D1 to match frontend/src/data/profile.ts (includes Discord, Mattermost, Hugging Face, Anthropic, Trello, Prettier, Opencode, Elementor, Mimo, Kimi)
...
INSERT INTO stack_groups (label, items, sort_order, created_at, updated_at) VALUES
  ...
  ('CMS', '["WordPress","Joomla","Elementor"]', 3, '2026-09-04 00:00:00', '2026-09-04 00:00:00'),
  ...
  ('AI & Assistant', '["Hermes","OpenClaw","OpenAI","DeepSeek","Grok","BigPickle","Muse Spark","Claude","Ollama","Gemini","Higgsfield","Mimo","Kimi","Hugging Face","Anthropic","Opencode"]', 6, '2026-09-04 00:00:00', '2026-09-04 00:00:00'),
