...
class AdminSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $stack = [
            ...
            'CMS' => ['WordPress', 'Joomla', 'Elementor'],
            ...
            'AI & Assistant' => ['Hermes', 'OpenClaw', 'OpenAI', 'DeepSeek', 'Grok', 'BigPickle', 'Muse Spark', 'Claude', 'Ollama', 'Gemini', 'Higgsfield', 'Mimo', 'Kimi', 'Hugging Face', 'Anthropic', 'Opencode'],
